...
[FZ_first,T] = SSN_(EEG_FZ_first_al(1:4001,i));
...
ind_G3G1_FZ_first(f,handles.n(matches),i)=1;
end
for k=1:size(ind_G3G1_FZ_first,2)
        ...
        G3G1_FZ_G2G1(k,:,i)=abs(G2G1_FZ_first(k,:,i)-ind_G3G1_FZ_first(k,:,i)); 
...
FZ_matrix1(:,:,i)=CMt_(matrixG3G1(:,:,i));
