...
ind_G3G1_F3_first(f,handles.n(matches),i)=1;
end
for k=1:size(ind_G3G1_F3_first,2)
        ...
        G3G1_F3_G2G1(k,:,i)=abs(G2G1_F3_first(k,:,i)-ind_G3G1_F3_first(k,:,i)); 
...
F3_matrix1(:,:,i)=CMt_(matrixG3G1(:,:,i));
