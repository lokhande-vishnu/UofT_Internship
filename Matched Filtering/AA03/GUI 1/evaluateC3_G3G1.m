...
[C3_first,T] = SSN_(EEG_C3_first_al(1:4001,i));
...
ind_G3G1_C3_first(f,handles.n(matches),i)=1;
end
for k=1:size(ind_G3G1_C3_first,2)
        ...
        G3G1_C3_G2G1(k,:,i)=abs(G2G1_C3_first(k,:,i)-ind_G3G1_C3_first(k,:,i)); 
...
C3_matrix1(:,:,i)=CMt_(matrixG3G1(:,:,i));
