% This function displays correct classifications of individual EEG trials 
% recorded durring hand grapsing

% This function calls the follwoing functions:

% evaluate(); filters trial signal and classifies it using the distance
% between the filtered trial and average of all oter filtered trials for
% each hand grasp
                                           
%circle(); Updates the GUI to represent the spatial location of electrodes
%which have classified the grasp correctly, red=correct, black=incorrect
