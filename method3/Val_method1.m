...
[~,ind]=max(bookc1(:,2)+bookc1(:,2)); ind, bookc1(ind,:)
[~,ind]=max(bookc2(:,2)+bookc2(:,2)); ind, bookc2(ind,:)
[~,ind]=max(bookc3(:,2)+bookc3(:,2)); ind, bookc3(ind,:)
[~,ind]=max(bookc4(:,2)+bookc4(:,2)); ind, bookc4(ind,:)
[~,ind]=max(bookc5(:,2)+bookc5(:,2)); ind, bookc5(ind,:)
[~,ind]=max(bookc6(:,2)+bookc6(:,3)); ind, bookc6(ind,:)
